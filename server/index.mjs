...
app.post("/generate-test-cases", async (req, res) => {
  ...
  try {
    ...
    const { data } = await openai.chat.completions.create( {
      "model": "gpt-3.5-turbo",
      "message": [{ "role": "user", "content": `Specifications: ${specifications} \n Code: ${code} Please create a test cases for above code by following specifications, test cases should simple and point wise, also suggest some instructions for tester` }],
      "temperature": 0.7
    }, {
      headers: {
